...
public class Constants {
    ...
    public static final String ACTION_RUN_ISERVICE = "com.elisoft.recarga.action.RUN_INTENT_SERVICE";
    public static final String ACTION_PROGRESS_EXIT = "com.elisoft.recarga.action.PROGRESS_EXIT";
